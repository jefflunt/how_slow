...
Gem::Specification.new do |gem|
  ...
  gem.description   = %q{You too can easily collect Rails app performance metrics without relying on 3rd party services or setting up a separate logging server!}
